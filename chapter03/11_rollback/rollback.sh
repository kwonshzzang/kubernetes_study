...
# 이지지 1.0 -> 2.0 변경 배포
kubectl set image deployment/my-app my-app=yoongeong/my-app:2.0

# 배포 사유 작성 "image update to 2.0"
...
# 롤백 변경 사유를 작성
kubectl annotate deployment/my-app kubernetes.io/change-cause="rollbacked to 1.0 fro a few bugs"